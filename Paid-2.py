...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰Arafat Mahin")
	subprocess.check_output(["am", "start", "https://m.me/100000545457649"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/https://arafat-mahin310/Approval3.txt/blob/main/Ap.txt"])').text
			if basesplit in plr:
				key = basesplit
